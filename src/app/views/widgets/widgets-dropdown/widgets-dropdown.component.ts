...
export class WidgetsDropdownComponent implements OnInit, AfterContentInit {
  ...
  datasets = [
    [{
      ...
      data: [980, 1024, 1100, 1125, 1180, 1220, 1248]
    }], [{
      label: 'Active tasks',
      backgroundColor: 'transparent',
      borderColor: 'rgba(255,255,255,.55)',
      ...
      data: [3600, 3850, 4020, 4170, 4300, 4480, 4720]
    }], [{
      ...
      data: [93.5, 94.2, 95.1, 95.8, 96.0, 96.2, 96.4],
      fill: true
    }], [{
      label: 'Departments',
      backgroundColor: 'rgba(255,255,255,.2)',
      borderColor: 'rgba(255,255,255,.55)',
      data: [18, 18, 19, 20, 21, 22, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23],
      barPercentage: 0.7
    }]
  ];
  optionsDefault = {
